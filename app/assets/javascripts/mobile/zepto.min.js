...
r=a.replace(/./,function(a){return a[0].toUpperCase()});return b===i?this[0]==window?window["inner"+r]:this[0]==p?p.documentElement["offset"+r]:(e=this.offset())&&e[a]:this.each(function(e){var r=c(this);r.css(a,f(this,b,e,r[a]()))})}});["after","prepend","before","append"].forEach(function(a,b){c.fn[a]=function(){var a=c.map(arguments,function(a){return h(a)?a:t.fragment(a)});if(1>a.length)return this;var e=this.length,r=1<e,x=2>b;return this.each(function(d,l){for(var p=0;p<a.length;p++){var w=
a[x?a.length-p-1:p];v(w,function(a){null!=a.nodeName&&("SCRIPT"===a.nodeName.toUpperCase()&&(!a.type||"text/javascript"===a.type))&&window.eval.call(window,a.innerHTML)});r&&d<e-1&&(w=w.cloneNode(!0));var f=b%2?l:l.parentNode;f?f.insertBefore(w,!b?l.nextSibling:1==b?f.firstChild:2==b?l:null):c(w).remove()}})};c.fn[b%2?a+"To":"insert"+(b?"Before":"After")]=function(b){c(b)[a](this);return this}});t.Z.prototype=c.fn;t.camelize=D;t.uniq=C;c.zepto=t;return c}();window.Zepto=Zepto;
...
s;m=setTimeout(k,750)}).bind("touchmove",function(b){m&&clearTimeout(m);m=null;d.x2=b.touches[0].pageX;d.y2=b.touches[0].pageY}).bind("touchend",function(){m&&clearTimeout(m);m=null;if(d.isDoubleTap)d.el.trigger("doubleTap"),d={};else if(d.x2&&30<Math.abs(d.x1-d.x2)||d.y2&&30<Math.abs(d.y1-d.y2))d.el.trigger("swipe")&&d.el.trigger("swipe"+h(d.x1,d.x2,d.y1,d.y2)),d={};else if("last"in d&&!(10<Math.abs(d.x1-d.x2)||10<Math.abs(d.y1-d.y2)))d.el.trigger("tap"),o=setTimeout(function(){o=null;d.el.trigger("singleTap");
d={}},250)}).bind("touchcancel",function(){o&&clearTimeout(o);m&&clearTimeout(m);m=o=null;d={}})});"swipe swipeLeft swipeRight swipeUp swipeDown doubleTap tap singleTap longTap".split(" ").forEach(function(d){b.fn[d]=function(b){return this.bind(d,b)}})})(Zepto);